...
setup(
    name='PepWitch',
    version='1.2',
    packages=[cython=0.27.3,conda=4.3.16,numpy==1.13.3,matplotlib==2.1.0,scipy==1.0.0,matplotlib-venn==0.11.5,statsmodels==0.8.0],
    url='',
...
install_requires=[cython=0.27.3,conda=4.3.16,numpy==1.13.3,matplotlib==2.1.0,scipy==1.0.0,matplotlib-venn==0.11.5,statsmodels==0.8.0],
